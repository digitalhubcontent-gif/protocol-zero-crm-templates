/**
 * CRM-09 — Sovereign Enterprise (Governance)
...
export const sovereignGovernanceLight: Omit<SemanticTokens, 'chart'> & {
    ...
    'text-primary': '#0f172a',
    'text-secondary': '#334155', // Darkened from #475569
    'text-muted': '#64748b', // Darkened from #94a3b8
    'text-inverse': '#ffffff',
    ...
    cssVars: {
        ...
        '--chart-axis': '#cbd5e1', // Darkened from #e2e8f0
        '--chart-label': '#64748b', // Darkened from #94a3b8
        '--chart-legend': '#475569', // Darkened from #64748b
